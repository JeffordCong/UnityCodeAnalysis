...
{
    public class UnifiedAssetBrowser : EditorWindow
    {
        ...
        [MenuItem("Tools/Asset Browsers/Unified Browser &b")]
        public static void OpenWindow()
        {
            var window = GetWindow<UnifiedAssetBrowser>();
            window.titleContent = new GUIContent("Unified Browser");
            window.Show();
        }
    ...
    public static class ProjectWindowUtil
    {
        public static void EnterFolderInProjectWindow(DefaultAsset folderAsset)
        {
            ...
            try
            {
                ...
                var showFolderContents = projectBrowserType.GetMethod( "ShowFolderContents", BindingFlags.NonPublic | BindingFlags.Instance, null, new[] { typeof(int), typeof(bool) }, null);
